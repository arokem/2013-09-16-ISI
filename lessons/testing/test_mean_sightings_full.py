...
def test_animal_not_present():
    animrec, animmean = get_sightings(filename, 'Moa')
    print animrec, animmean
    assert animrec == 0, 'Extinct animals should always return zero records'
    assert animmean == 0, 'Extinct animals should return zero mean'
